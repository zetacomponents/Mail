...
//        $this->assertEquals( 'Simple mail with text subject and body', $mail->subject );
    ...
    public function testVarious1()
    {
        ...
        $this->assertEquals( 1, count( $mail ) );
        $mail = $mail[0];
        $this->assertEquals( array( new ezcMailAddress( 'xx@ez.no', 'BÃ¥rd Farsted', 'utf-8' ) ), $mail->cc );
    }
    ...
    public function testVarious4()
    {
        ...
        $this->assertEquals( 1, count( $mail ) );
        $mail = $mail[0];
        $this->assertEquals( array( new ezcMailAddress( 'foobar@example.hu', 'FOO BÃ¡r', 'utf-8' ) ), $mail->from );
    }
